...
import 'package:jaberah/controllers/user/semesterStudentsReportsController.dart';
import 'package:jhijri/_src/_jHijri.dart';
import 'package:jhijri_picker/_src/_jWidgets.dart';

class SemesterStudentsReports extends StatelessWidget {
  final SemesterStudentsReportsController controller =
      Get.put(SemesterStudentsReportsController());
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return _buildStudentsCard(
                            controller.semesterReport[index], context);
                      },
                    ),
                  );
                }
  ...
  Widget _buildStudentsCard(SemesterReportModel student, BuildContext context) {
    return Card(
      elevation: 4,
                ...
                IconButton(
                    onPressed: () {
                      ...
                      var gradeController = TextEditingController(
                          text: student.midFinalGrade.toString());
                      showDialog(
                          context: context,
                          builder: (context) {
                            return AlertDialog(
                              title: Text(
                                "تعديل درجة الامتحان النصفي",
                                style: TextStyle(fontSize: 20),
                              ),
                              content: Form(
                                  key: formKey,
                                ...
                                TextButton(
                                    onPressed: () async {
                                      if (formKey.currentState!.validate()) {
                                        await controller.UpdateMidFinal(
                                            studentId: student.studentId,
                                            midFinalGrade: double.tryParse(
